...
int main() {
    ...
    Shader modelShader("../shader/4.9.model_explode.vert",
                       "../shader/4.9.model_explode.geom",
                       "../shader/4.9.model_explode.frag");

    Shader normalDisplayShader("../shader/4.9.normal_display.vert",
                               "../shader/4.9.normal_display.geom",
                               "../shader/4.9.normal_display.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // modelShader.setFloat("time", -M_PI_2);
