...
int main() {
    ...
    // -------------------------
    Shader shader("../shader/5.3.2.point_shadows.vert", "../shader/5.3.2.point_shadows.frag");
    Shader simpleDepthShader("../shader/5.3.2.1.point_shadows_depth.vert",
                             "../shader/5.3.2.1.point_shadows_depth.geom",
                             "../shader/5.3.2.1.point_shadows_depth.frag");
